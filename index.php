...
<section id="third-section">
    <div class="container">
        ...
        <div class="row wow fadeInRightBig margin-div-row">
            <div class="col-md-2 col-xs-12 div-img-responsive imgweb">
            ...
            <div class="col-md-2 col-xs-12 div-img-responsive imgmob">
                <img class="img-redondas" src="http://convoca.pe/sites/default/files/styles/full_post/public/ultimoppk_0.jpg?itok=T66wQClI">
            </div>
        </div>
...
<script>
    var urlBase="memoriasdelacorrupcion.convoca.pe/sombras-del-indulto/";

    $(".share_fb").on("click",function() {
        window.open("https://www.facebook.com/sharer/sharer.php?u=http://"+urlBase, "_blank", "toolbar=0, menubar=0, scrollbars=0, resizable=no, titlebar=0, top=250, left=400, width=600, height=280");
    });

    $(".share_tw").on("click",function() {
        titulo = encodeURIComponent("#MemoriasDeLaCorrupción Sigue en este especial interactivo el rastro de la corrupción en Perú");
        window.open("http://twitter.com/intent/tweet?text=" + titulo + "&url=http://"+urlBase, "_blank", "toolbar=0, menubar=0, scrollbars=0, resizable=no, titlebar=0, top=250, left=400, width=600, height=280");
    });
</script>
</body>
</html>
